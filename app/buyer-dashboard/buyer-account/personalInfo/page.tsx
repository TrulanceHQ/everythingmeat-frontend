...
// import { useFetchStockList } from "../utils/action";
...
const Page = () => {
  ...
  // const data = useFetchStockList({ pageNumber: 1 });
  ...
  return (
    <div className="mb-2 w-full lg:w-[800px]">
      {/* <div>
        {data?.map((product) => (
          <div key={product.id}>
            ...
            <img src={product.healthSatisfactionImage} alt={product.productName} />
          </div>
        ))}
      </div> */}
      ...
      <form className="p-2 flex flex-col gap-2">
        ...
        {/* Submit Button */}
        <Button className="bg-red-700 text-white rounded-md flex items-start w-64 p-3 gap-2">
          Submit
        </Button>
      </form>
    </div>
...
export default Page;
// To view this page go to: "http://localhost:3000/buyer-dashboard/buyer-account/personalInfo"
