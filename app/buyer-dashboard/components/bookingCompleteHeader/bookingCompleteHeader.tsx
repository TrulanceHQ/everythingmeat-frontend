...
const BookingHeader = () => {
    return (
        <div className="bg-gray-100 flex flex-col justify-center items-center h-36">
            ...
            <h3 className="absoulte font-bold text-2xl md:text-3xl lg:text-4xl">My Account</h3>
            <p className="font-normal text-base md:text-lg lg:text-xl">Home / Booking Complete</p>
