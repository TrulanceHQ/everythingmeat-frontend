    ...
    return (
        <div className="border border-customGray flex flex-col flex-shrink justify-between gap-2 m-1 md:m-5 p-3 rounded-lg">
            <div className="border-b border-customGray p-3 items-start hidden md:flex ">
                <h2 className="text-customGray md:text-xl lg:text-2xl font-bold">Booking Summary</h2>
            </div>
            {/* ITEM */}
            <div className="flex flex-col gap-1">
                <div className="flex flex-row justify-between gap-5">
                    <p className="text-customGray md:text-xl font-normal">Item:</p>
                    <p className=" text-base md:text-xl font-medium">{bookingItems.item}</p>
                </div>
            </div>
            {/* SUBTOTAL */}
            <div className="flex flex-col gap-1">
                <div className="flex flex-row justify-between">
                    ...
                    <p className="text-base md:text-xl font-medium">{formatCurrency(bookingItems.subtotal)}</p>
                </div>
            </div>
            {/* DELIVERY */}
            <div className="flex flex-col gap-1">
                <div className="flex flex-row justify-between">
                    ...
                    <p className="text-base md:text-xl font-medium">{formatCurrency(bookingItems.delivery)}</p>
                </div>
            </div>
            {/* TAX */}
            <div className="flex flex-col gap-1">
                <div className="flex flex-row justify-between">
                    ...
                    <p className="text-base md:text-xl font-medium">{formatCurrency(bookingItems.tax)}</p>
                </div>
            </div>
            {/* COUPON DISCOUNT */}
            <div className="flex flex-col gap-1">
                <div className="flex flex-row justify-between">
                    ...
                    <p className="text-base md:text-xl font-medium">-{formatCurrency(bookingItems.couponDiscount)}</p>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-1">
                <div className="flex flex-row justify-between">
                    ...
                    <p className="text-base md:text-xl font-medium">{formatCurrency(total)}</p>
                </div>
