                    ...
                    >
                        <CardHeader>
                            <div className="relative">
                                <Image
                                    src={stock.healthSatisfactionImage}
                                    alt={stock.productId}
                                    width={300}
                                    height={208}
                        ...
                        <CardContent>
                            ...
                            <CardTitle className="md:text-3xl text-xl font-semibold my-2">
                                {stock.productName}
                            </CardTitle>
                            <p className="text-customRed font-bold md:text-xl text-lg">
                                ₦{stock.productPrice.toLocaleString()}
                            ...
                            <p>
                                ...
                                <span className="text-customRed font-bold">
                                    {stock.slotsOut ? stock.slotOut : "N/A"}
                                </span>{" "}
                                out of <span className="font-bold">{stock.totalSlots}</span>
                            </p>
                        </CardContent>
                        {/* Card Details End */}
                        <CardFooter>
                            <Button
                                ...
                                onClick={() => handleBookNow(stock.productId)}
                            >
                                Book Now
                            </Button>
                        </CardFooter>
