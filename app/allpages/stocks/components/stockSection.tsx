...
//import FallBackStocks from "./stocks";
...
const StockSection = () => {
    ...
    const filteredStocks = stocks.filter(
        (stock) =>
            stock.productPrice >= priceRange[0] &&
            stock.productPrice <= priceRange[1] &&
    ...
    return (
        <div className="bg-customGray pt-5 min-h-screen relative">
            ...
            <div className="text-center mt-5 mb-20">
                <h1 className="md:text-3xl text-2xl font-bold text-black mb-3">Stocks</h1>
