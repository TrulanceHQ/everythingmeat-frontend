...
const AboutHero = () => {
  ...
  return (
    <div className="bg-gray-100 pt-5 min-h-screen relative">
      ...
      {/* Welcome Section */}
      <div className="bg-white px-5 py-10 md:px-10 items-center flex flex-col relative">
        {/* Title Section */}
        <div className="space-y-2 xl:space-x-10">
          ...
          <p className="font-medium xl:pr-8">
            At Everything Meat, we’re very passionate about transforming the
            very essence of how you procure and relish top-tier meats. With our
            ...
            From farm to table, we uphold the pillars of freshness,
            transparency, and unwavering satisfaction, ensuring that every
            interaction with us is a culinary delight. Join us in this
            gastronomic adventure and experience the epitome of meat excellence.
            Reach out today, and let’s embark on this savory journey together!
          </p>
        </div>
              ...
              <div
                ...
                className={`flex flex-col items-center ${
                  index < stats.length - 1
                    ? "border-gray-400 md:border-r md:h-14 md:border-b-0 border-b "
                    : ""
                }`}
              >
                <p className="text-xl lg:text-xl md:text-lg font-bold">
                  {stat.value}
                </p>
                <p className="text-base md:text-sm lg:text-base md:mb-0 mb-2">
                  {stat.label}
                </p>
              </div>
            ))}
