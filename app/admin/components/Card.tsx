...
type Props = {
  ...
  onCardClick: (cardLink: string) => void;
};
    ...
    <div onClick={handleClick} className="cursor-pointer">
      <div className="bg-white w-full max-w-72 h-48 rounded-3xl px-4 py-8 sm:p-8">
        ...
        <div className="flex flex-row justify-between">
          <h3 className="font-medium text-xl lg:text-2xl flex flex-row justify-center items-center">
            {showNairaSymbol && <TbCurrencyNaira />}
            {amount}
          </h3>
